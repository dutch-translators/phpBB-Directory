...
$lang = array_merge($lang, array(
	'DIR_ARE_WATCHING_CAT'					=> 'Je bent geabonneerd om deze categorie, om om de hoogte gehoude te worden van nieuwe websites in deze categorie.',
	...
	'DIR_BANNER_EMPTY_FILEUPLOAD'			=> 'Het banner bestand is leeg.',
	'DIR_BANNER_EMPTY_REMOTE_DATA'			=> 'De ingevoerde banner kan niet worden verwerkt omdat de gegevens incorrent of beschadigt is.',
	'DIR_BANNER_IMAGE_FILETYPE_MISMATCH'	=> ' Verkeerde bannerbestands type: verwachte extensie %1$s ingevoerde extensie %2$s.',
	...
	'DIR_BANNER_PHP_SIZE_NA'				=> 'De banner grootte is te groot.<br />De maximale grootte die is ingesteld in de php.ini kan niet worden vastgesteld".',
	'DIR_BANNER_PHP_SIZE_OVERRUN'			=> 'De banner grootte is te groot. De maximaal toegestane grootte is %d Mo.<br />Houd er rekening mee dat dit is ingesteld in de php.ini en niet overtroffen kan worden.',
	...
	'DIR_BANNER_URL_INVALID'				=> 'Het banner adres is ongeldig',
	'DIR_BANNER_URL_NOT_FOUND'				=> 'Het bestand kan niet worden gevonden.',
	'DIR_BANNER_WRONG_FILESIZE'				=> 'De banner grootte moet tussen de 0 en %1d %2s zijn.',
	'DIR_BANNER_WRONG_SIZE'					=> 'De gespicificeerde banner heeft een breedte vanm %3$d pixels en een hoogte van %4$d pixels. De banner mag niet meer dan %1$d pixels breed en %2$d hoog zijn.',
	...
	'DIR_CLICK_RETURN_COMMENT'				=> 'Klik %shier%s om terug te gaan naar de reactie pagina',
	...
	'DIR_ERROR_KEYWORD'						=> 'Je moet sleutenwoorden invoeren om te zoeken.',
	'DIR_ERROR_NOT_AUTH'					=> 'Je hebt geen toestemming om deze handeling uit te voeren',
	'DIR_ERROR_NOT_FOUND_BACK'				=> 'De gespecificeerde voor de link back is niet gevonden.',
	...
	'DIR_ERROR_NO_LINK_BACK'				=> 'De link back is niet gevonden op de pagina die je gespecificeerd hebt',
	'DIR_ERROR_SUBMIT_TYPE'					=> 'Verkeerde gegevens in dir_submit_type function',
	...
	'DIR_ERROR_WRONG_DATA_BACK'				=> 'Het adres voor de link back moet een geldige link zijn, inclusief protocol. Bijvoorbeeld: http://www.example.com/.',
	...
	'DIR_NEW_SITE_ACTIVE'					=> 'Je website is toegoevoegd, maar moet eerst worden goedgekeurd voor je hem kan zien in de directory',
	...
	'DIR_SUBMIT_TYPE_1'						=> 'Je website moet eerst goedgekeurd worden door een beheerer.',
	...
	'TOO_LONG_BACK'							=> 'Adres met de link back is te lang (255 characters maximum)',
	...
	'TOO_LONG_SITE_NAME'					=> 'De naam die je hebt opgegeven is te lang (100 tekens max)',
	'TOO_LONG_URL'							=> 'De link die je hebt opgegeven is te lang (255 tekens max)',
	'TOO_MANY_ADDS'							=> 'Je hebt het maximaal aantal pogingen om een website toe te voegen bereikt. Prober het later nog eens.',
	'TOO_SHORT_BACK'						=> 'Je moet het adres van de pagina invullen waar de back link is.',
	...
	'WRONG_DATA_RSS'						=> 'De ingevoerde RSS feeds link moet geldig zijn, inclusief protocol. Bijvoorbeld: http://www.example.com/.',
));
